...
class Prompt(object):
    ...
    button_fg_color = attr.ib(type=Optional[Text], default='')
    button_bg_color = attr.ib(type=Optional[Text], default='')
...
class UserInput(base_plugs.FrontendAwareBasePlug):
  ...
  """
    ...
    def _asdict(self) -> Optional[Dict[Text, Any]]:
        ...
        with self._cond:
            ...
            return {
                ...
                'button-fg-color': self._prompt.button_fg_color,
                'button-bg-color': self._prompt.button_bg_color
            }
    ...
    def prompt(self,
               ...
               button_bg_color: Optional[Text] = '') -> Text:
    ...
    """
        self.start_prompt(message, text_input, cli_color, image_url, button_fg_color, button_bg_color)
